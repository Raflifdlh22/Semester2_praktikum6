            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger" href="../../process/pelanggan/delete_pelanggan.php?iddel=<?= $row['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data pelanggan <?= $row['nama'] ?>?')) {return false}">Delete</a>
                    </td>
                </tr>
            <?php
                $nomor++;
